...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Refund.amount'
        db.add_column('payment_refund', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Refund.amount'
        db.delete_column('payment_refund', 'amount')
    ...
    models = {
        'payment.card': {
            ...
            'short_pk': ('django.db.models.fields.CharField', [], {'max_length': '6', 'blank': 'True', 'unique': 'True'})
        },
        'payment.charge': {
