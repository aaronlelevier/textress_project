...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hotel.stripe_id'
        db.delete_column('main_hotel', 'stripe_id')


    def backwards(self, orm):
        # Adding field 'Hotel.stripe_id'
        db.add_column('main_hotel', 'stripe_id',
    ...
    models = {
        ...
        'main.hotel': {
            ...
            'hotel_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.userprofile': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'primary_key': 'True', 'unique': 'True', 'to': "orm['auth.User']", 'related_name': "'profile'"})
        },
        'payment.customer': {
