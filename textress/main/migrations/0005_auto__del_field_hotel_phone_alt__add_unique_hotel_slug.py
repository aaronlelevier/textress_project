...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hotel.phone_alt'
        db.delete_column('main_hotel', 'phone_alt')

        # Adding unique constraint on 'Hotel', fields ['slug']
        db.create_unique('main_hotel', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Hotel', fields ['slug']
        db.delete_unique('main_hotel', ['slug'])

        # Adding field 'Hotel.phone_alt'
        db.add_column('main_hotel', 'phone_alt',
    ...
    models = {
        ...
        'main.hotel': {
            ...
            'address_state': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "'Alabama'", 'max_length': '25'}),
            'address_zip': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'max_length': '5'}),
