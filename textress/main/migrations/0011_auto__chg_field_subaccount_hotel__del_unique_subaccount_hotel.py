...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Subaccount.hotel'
        db.alter_column('main_subaccount', 'hotel_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Hotel'], unique=True))
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'primary_key': 'True', 'related_name': "'profile'", 'unique': 'True'})
        },
        'payment.customer': {
