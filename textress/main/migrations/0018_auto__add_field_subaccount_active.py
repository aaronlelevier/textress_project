...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subaccount.active'
        db.add_column('main_subaccount', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subaccount.active'
        db.delete_column('main_subaccount', 'active')
    ...
    models = {
        ...
        'main.subaccount': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hotel': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.Hotel']", 'unique': 'True', 'related_name': "'subaccount'"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
        ...
        'main.userprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'primary_key': 'True', 'to': "orm['auth.User']", 'unique': 'True', 'related_name': "'profile'"})
        },
        'payment.customer': {
