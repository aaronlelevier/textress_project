...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Hotel', fields ['admin_id']
        db.create_unique('main_hotel', ['admin_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Hotel', fields ['admin_id']
        db.delete_unique('main_hotel', ['admin_id'])
