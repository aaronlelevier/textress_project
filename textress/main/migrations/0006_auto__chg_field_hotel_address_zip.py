...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'main.hotel': {
            ...
            'address_city': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'address_line1': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'address_line2': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'address_state': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '25', 'default': "'Alabama'"}),
            'address_zip': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'max_length': '5', 'null': 'True'}),
        ...
        'main.userprofile': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'primary_key': 'True', 'to': "orm['auth.User']", 'related_name': "'profile'"})
        },
        'payment.customer': {
