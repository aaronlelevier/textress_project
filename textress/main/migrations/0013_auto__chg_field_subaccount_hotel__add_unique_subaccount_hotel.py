...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subaccount.hotel'
        db.alter_column('main_subaccount', 'hotel_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['main.Hotel']))
        # Adding unique constraint on 'Subaccount', fields ['hotel']
        db.create_unique('main_subaccount', ['hotel_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subaccount', fields ['hotel']
        db.delete_unique('main_subaccount', ['hotel_id'])


        # Changing field 'Subaccount.hotel'
        db.alter_column('main_subaccount', 'hotel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Hotel']))
    ...
    models = {
        ...
        'main.subaccount': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hotel': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['main.Hotel']", 'related_name': "'subaccount'"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
