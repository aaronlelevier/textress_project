    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_phone', models.CharField(help_text=b'10-digit phone number. i.e.: 7025101234', unique=True, max_length=12, verbose_name='Contact Phone Number')),
                ...
                ('twilio_sid', models.CharField(max_length=100, verbose_name='Twilio Sid', blank=True)),
                ('twilio_auth_token', models.CharField(max_length=100, verbose_name='Twilio Auth Token', blank=True)),
                ('twilio_phone_number', models.CharField(max_length=12, verbose_name='Twilio Phone Number', blank=True)),
                ('twilio_ph_sid', models.CharField(max_length=100, verbose_name='Twilio Phone Number Sid', blank=True)),
