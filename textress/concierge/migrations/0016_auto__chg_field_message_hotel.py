...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.hotel'
        db.alter_column('concierge_message', 'hotel_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Hotel']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.hotel'
        raise RuntimeError("Cannot reverse this migration. 'Message.hotel' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Message.hotel'
        db.alter_column('concierge_message', 'hotel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Hotel']))
    ...
    models = {
        ...
        'concierge.message': {
            ...
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hotel': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['main.Hotel']", 'blank': 'True', 'related_name': "'messages'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'sid': ('django.db.models.fields.CharField', [], {'null': 'True', 'unique': 'True', 'blank': 'True', 'max_length': '55'}),
        ...
        'concierge.reply': {
            'Meta': {'object_name': 'Reply', 'ordering': "['-created']"},
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
