...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.hotel'
        db.add_column('concierge_message', 'hotel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=23, blank=True, to=orm['main.Hotel'], related_name='messages'),
                      keep_default=False)

        # Adding field 'Message.insert_date'
        db.add_column('concierge_message', 'insert_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 12, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.hotel'
        db.delete_column('concierge_message', 'hotel_id')

        # Deleting field 'Message.insert_date'
        db.delete_column('concierge_message', 'insert_date')
    ...
    models = {
        ...
        'concierge.message': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'from_ph': ('django.db.models.fields.CharField', [], {'default': "'+17024302691'", 'blank': 'True', 'max_length': '12'}),
            'guest': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['concierge.Guest']"}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'received': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'default': 'False', 'blank': 'True'}),
