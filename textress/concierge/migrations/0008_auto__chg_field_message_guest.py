...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.guest'
        db.alter_column('concierge_message', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['concierge.Guest'], default=37))

    def backwards(self, orm):

        # Changing field 'Message.guest'
        db.alter_column('concierge_message', 'guest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['concierge.Guest'], null=True))
    ...
    models = {
        ...
        'concierge.message': {
            ...
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hotel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Hotel']", 'blank': 'True', 'related_name': "'messages'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
