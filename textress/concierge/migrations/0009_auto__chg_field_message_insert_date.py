...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('concierge_message', 'insert_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.insert_date'
        raise RuntimeError("Cannot reverse this migration. 'Message.insert_date' and its values cannot be restored.")
    ...
    models = {
        ...
        'concierge.message': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_ph': ('django.db.models.fields.CharField', [], {'max_length': '12', 'blank': 'True', 'default': "'+17024302691'"}),
