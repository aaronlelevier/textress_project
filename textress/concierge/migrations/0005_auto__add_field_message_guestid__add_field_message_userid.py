...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.guestid'
        db.add_column('concierge_message', 'guestid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.userid'
        db.add_column('concierge_message', 'userid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.guestid'
        db.delete_column('concierge_message', 'guestid')

        # Deleting field 'Message.userid'
        db.delete_column('concierge_message', 'userid')
    ...
    models = {
        ...
        'concierge.message': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_ph': ('django.db.models.fields.CharField', [], {'max_length': '12', 'default': "'+17027284769'", 'blank': 'True'}),
            'guest': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['concierge.Guest']", 'null': 'True', 'blank': 'True'}),
            'guestid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hotel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['main.Hotel']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'sid': ('django.db.models.fields.CharField', [], {'max_length': '55', 'null': 'True', 'unique': 'True', 'blank': 'True'}),
