...
class AccountTests(TestCase):
    ...
    #     # Hotel
    #     self.assertIn("Hotel Info", response.content)
    #     self.assertIn(reverse('main:hotel_update', kwargs={'pk': self.user.profile.hotel.pk}), response.content)
    ...
    #     self.assertIn("Account Payment Settings", response.content)
    #     self.assertIn(reverse('acct_cost_update', kwargs={'pk': self.user.profile.hotel.pk}), response.content)
