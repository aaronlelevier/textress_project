...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AcctTrans.debit'
        db.add_column('account_accttrans', 'debit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AcctTrans.credit'
        db.add_column('account_accttrans', 'credit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AcctTrans.debit'
        db.delete_column('account_accttrans', 'debit')

        # Deleting field 'AcctTrans.credit'
        db.delete_column('account_accttrans', 'credit')
